...
```toml
[dependencies]
ignitia = { version = "0.2.3", features = ["tls", "websocket", "self-signed"] }
...
### v0.2.3 - Performance Champion Release 🏆
...
echo 'ignitia = { version = "0.2.3", features = ["tls", "websocket", "self-signed"] }' >> Cargo.toml

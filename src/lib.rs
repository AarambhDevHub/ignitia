...
//! ```
//! [dependencies]
//! ignitia = { version = "0.2.1", features = ["tls", "websocket"] }
...
//!
//! # Individual features
//! ignitia = { version = "0.2.1", features = ["tls"] }        # HTTPS support only
//! ignitia = { version = "0.2.1", features = ["websocket"] }  # WebSocket support only
//! ignitia = "0.2.1"                                          # HTTP only (minimal)
//! ```
//!

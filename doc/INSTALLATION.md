...
**For Web APIs:**
```toml
ignitia = { version = "0.2.2", features = ["tls"] }
```
...
**For Development:**
```toml
ignitia = { version = "0.2.2", features = ["websocket", "tls", "self-signed"] }
```
...
[dependencies]
ignitia = { version = "0.2.2", features = ["websocket"] }
...
```toml
[dependencies]
ignitia = { version = "0.2.2", features = ["websocket", "self-signed"] }
